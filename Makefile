...
.PHONY: test
test:
	go test -timeout=3s -count=10 -race -failfast -shuffle=on -short ./...
	go test -timeout=20s -count=1 -race -failfast  -shuffle=on ./... -coverprofile=./cover.profile -covermode=atomic -coverpkg=./...
