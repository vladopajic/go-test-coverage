...
.PHONY: test
test:
	go test -timeout=3s -count=10 -failfast -shuffle=on -short ./...
	go test -timeout=20s -count=1 -failfast  -shuffle=on ./... -coverprofile=./cover.profile -covermode=atomic -coverpkg=./...
