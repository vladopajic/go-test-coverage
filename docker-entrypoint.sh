...
[ "$INPUT_THRESHOLD_FILE" ] && args+=("--threshold-file=$INPUT_THRESHOLD_FILE")
[ "$INPUT_THRESHOLD_PACKAGE" ] && args+=("--threshold-package=$INPUT_THRESHOLD_PACKAGE")
[ "$INPUT_THRESHOLD_TOTAL" ] && args+=("--threshold-total=$INPUT_THRESHOLD_TOTAL")
